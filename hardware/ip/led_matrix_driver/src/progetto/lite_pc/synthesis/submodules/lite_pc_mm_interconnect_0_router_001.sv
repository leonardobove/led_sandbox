...
module lite_pc_mm_interconnect_0_router_001_default_decode
  #(
...
module lite_pc_mm_interconnect_0_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD7 = log2ceil(64'h8001050 - 64'h8001048); 
    // -------------------------------------------------------
    ...
    lite_pc_mm_interconnect_0_router_001_default_decode the_default_decode(
    ...
    // ( 0x8001048 .. 0x8001050 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 28'h8001048  && read_transaction  ) begin
