...
SOPCINFO_FILE := C:/universita/led_sandbox/sopc/led_sandbox_sopc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is led_sandbox_sopc
SOPC_NAME := led_sandbox_sopc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001070
SOPC_SYSID_FLAG += --sidp=0x8001070
ELF_PATCH_FLAG  += --sidp 0x8001070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1747313956
SOPC_SYSID_FLAG += --timestamp=1747313956
ELF_PATCH_FLAG  += --timestamp 1747313956
